...
export function CampaignSetCreator({ open, onOpenChange, onApplyVariation, canvasState }: CampaignSetCreatorProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[85vh] p-0 gap-0 bg-card/95 backdrop-blur-xl border-border/50">
        <DialogHeader className="p-6 pb-4 border-b border-border/50">
          <DialogTitle className="flex items-center gap-3">
            ...
            <div>
              <span className="text-xl font-bold">Campaign Set Creator</span>
              <p className="text-sm text-muted-foreground font-normal">Generate hero + channel-optimized variations</p>
            </div>
          </DialogTitle>
        </DialogHeader>
